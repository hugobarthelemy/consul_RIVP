class Moderation::BudgetInvestmentsController < Moderation::BaseController
  ...
  def update
    ...
    if @investment.update(budget_investment_params)
      redirect_to moderation_budget_budget_investment_path(@budget, @investment, Budget::Investment.filter_params(params)),
